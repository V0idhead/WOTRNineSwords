            ...
            var ability = AbilityConfigurator.New("StrikeTheHourglassAbility", "B805C26B-D109-4E22-8828-79840C0EE525")
              ...
              (
                ActionsBuilder.New().Add<MeleeAttackExtended>(mae => {
                    mae.OnHit =
                  ActionsBuilder.New()
                    .SavingThrow(Kingmaker.EntitySystem.Stats.SavingThrowType.Will, customDC: ContextValues.Constant(11), conditionalDCModifiers: Helpers.GetManeuverDCModifier(Kingmaker.UnitLogic.Mechanics.Properties.UnitProperty.StatBonusWisdom, EternalMoment.RivenHourglassFocusFactGuid),
