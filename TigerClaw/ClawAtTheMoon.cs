  ...
  internal class ClawAtTheMoon
  {
    ...
    public static void Configure()
    {
      ...
      var ability = AbilityConfigurator.New(name, "08B0338B-7491-4443-B4D9-C1A98B15E515")
        ...
        (
          ActionsBuilder.New()
          .Add<OpposedCheck>(a => new OpposedCheck(c => c.Stats.SkillAthletics.ModifiedValue, t => t.Stats.AC,
            onSuccess: ActionsBuilder.New().ApplyBuff(successBuff, ContextDuration.Fixed(1), toCaster: true).Add<ContextMeleeAttackRolledBonusDamage>(bd => bd.ExtraDamage = new DiceFormula(2, DiceType.D6)).Build(),
            onFail: ActionsBuilder.New().MeleeAttack().Build()
          ))
        )
