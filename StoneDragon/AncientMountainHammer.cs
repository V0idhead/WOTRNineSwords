  ...
  static class AncientMountainHammer
  {
    ...
    public static void Configure()
    {
      ...
      var ability = AbilityConfigurator.New(name, "2ABB6CB5-8E9B-4FB4-AD02-384E7D8A28E2")
        ...
        (
          ActionsBuilder.New().ApplyBuff(buff, ContextDuration.Fixed(1), toCaster: true).Add<ContextMeleeAttackRolledBonusDamage>(bd => bd.ExtraDamage = new DiceFormula(12, DiceType.D6))
        )
