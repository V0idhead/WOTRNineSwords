...
namespace VoidHeadWOTRNineSwords.Common
{
  static class DisciplineProficencies
  {
    ...
    public const string SettingSunProficencyGuid = "397CDCE0-A387-4955-83CD-BB2C9F64FA1E";
    ...
    public static void Configure()
    {
      ...
      FeatureConfigurator.New("IronHeartProficency", IronHeartProficencyGuid)
        ...
        .SetIsClassFeature()
        .Configure();
      FeatureConfigurator.New("SettingSunProficency", SettingSunProficencyGuid)
        .SetHideInUI()
        .SetIsClassFeature()
        .Configure();
