    ...
    public static void Configure()
    {
      ...
      var ability = AbilityConfigurator.New("SteelyStrikeAbility", "480F8ACA-C49F-4855-A5ED-CDDB4B4B1DBD")
        ...
        .AddAbilityEffectRunAction(
          actions: ActionsBuilder.New().ApplyBuff(attackBuff, ContextDuration.Fixed(1)).MeleeAttack().ApplyBuff(buff, ContextDuration.Fixed(1, DurationRate.Rounds), toCaster: true).ApplyBuff(targetBuff, ContextDuration.Fixed(1, DurationRate.Rounds))
         )
